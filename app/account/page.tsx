              ...
              <div className="p-8">
                <div className="mb-6">
                  ...
                  <p className="leading-relaxed text-[#6B7280]">
                    ...
                    premium collection of products, add items to your cart, and experience seamless shopping. While this
                    is a demonstration, all features are fully functional including real-time cart management, product
                    filtering, and dynamic pricing.
                  </p>
                </div>
            ...
            <div className="grid gap-6 md:grid-cols-2">
              ...
              <Card className="transition-shadow hover:shadow-lg">
                <CardContent className="p-6">
                  ...
                  <h3 className="mb-4 font-semibold text-[#1E3A4F]">Real Product Data</h3>
                  <p className="text-sm leading-relaxed text-[#6B7280]">
          ...
          <Card className="border-[#E87654] bg-gradient-to-r from-[#E87654]/5 to-transparent">
            <CardContent className="p-6">
              ...
              <p className="leading-relaxed text-[#6B7280]">
                ...
                filters, and see how everything works together seamlessly. If you have any questions, visit our contact
                page!
              </p>
            </CardContent>
          </Card>
